# HAMVPN Subscription Interface

## Direction

- Audience: non-technical subscribers opening a personal link, usually on a phone.
- Primary task: understand subscription health and connect the current device in under a minute.
- Feel: calm, protected and unmistakably HAMVPN; technical detail stays secondary.
- Signature: a low-opacity HAMVPN mascot behind a three-step connection rail.

## Product world

- Domain: secure tunnel, signal, route, device, subscription health, traffic and support.
- Palette: midnight aubergine, plum glass, ultraviolet, lavender ink, signal mint, warning amber.
- Avoid: generic four-color stat grids, cyan-heavy defaults and decorative gradients without meaning.
